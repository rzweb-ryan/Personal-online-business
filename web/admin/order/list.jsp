					...
					<tr>
						<td class="ta_01" align="center" bgColor="#f5fafe">
							<table cellspacing="0" cellpadding="1" rules="all"
								...
								<s:iterator var="order" value="pageBean.pageContent">
								...
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<s:iterator var="orderItem" value="#order.orderItem" status="status">
									...
									<td align="center" width="18%" colspan="8">
										...
										<td align="center" width="18%" colspan="8">
											第 <s:property value="pageBean.page"/>/<s:property value="pageBean.totalPage"/>页
											<s:if test="pageBean.page != 1">
												<a href="${ pageContext.request.contextPath }/order_adminFindAll.action?page=1&state=<s:property value="state"/>">首页</a> |
												<a href="${ pageContext.request.contextPath }/order_adminFindAll.action?page=<s:property value="pageBean.page-1"/>&state=<s:property value="state"/>">上一页</a> |
											</s:if>
											<s:if test="pageBean.page != pageBean.totalPage">
												<a href="${ pageContext.request.contextPath }/order_adminFindAll.action?page=<s:property value="pageBean.page+1"/>&state=<s:property value="state"/>">下一页</a> |
												<a href="${ pageContext.request.contextPath }/order_adminFindAll.action?page=<s:property value="pageBean.totalPage"/>&state=<s:property value="state"/>">尾页</a>
											</s:if>
										</td>
									</s:else>

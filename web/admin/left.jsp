...
<div class="dtree">
	...
	<script type="text/javascript">
		...
		d.add('010101','0101','用户管理','${pageContext.request.contextPath}/adminUser_adminFindAll.action?page=1','','mainFrame');
		d.add('0102','01','商品管理','${pageContext.request.contextPath}/login/welcome.jsp','','mainFrame');
		d.add('010201','0102','商品管理','${pageContext.request.contextPath}/product_adminList.action?page=1','','mainFrame');
		...
		d.add('010302','0103','未付款订单','${pageContext.request.contextPath}/order_adminFindAll.action?page=1&state=1','','mainFrame');
		d.add('010303','0103','已付款订单','${pageContext.request.contextPath}/order_adminFindAll.action?page=1&state=2','','mainFrame');
		d.add('010304','0103','已发货订单','${pageContext.request.contextPath}/order_adminFindAll.action?page=1&state=3','','mainFrame');
		d.add('010305','0103','已完成订单','${pageContext.request.contextPath}/order_adminFindAll.action?page=1&state=4','','mainFrame');

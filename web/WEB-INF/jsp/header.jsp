...
<div class="span5">
    <div class="logo">
        <a href="${pageContext.request.contextPath}/index.action">
            <%--logo--%><img src="${pageContext.request.contextPath}/image/r___________renleipic_01/logo.gif1" alt="华人超市"/>
        </a>
    </div>
</div>
<div class="span9">
    ...
    <ul>
        <s:if test="#session.existUser!=null">
            ...
            <li id="headerRegister" class="headerRegister" style="display: list-item;">
                <a href="${pageContext.request.contextPath}/order_list.action"> 订单</a>|
            </li>
            <li id="headerRegister" class="headerRegister" style="display: list-item;">
        ...
        <s:else>
            ...
            <li id="headerRegister" class="headerRegister" style="display: list-item;">
                <a href="${pageContext.request.contextPath}/user_regPage.action">注册</a>|
            </li>
        </s:else>
        <li>
            <a>会员中心</a>
...
<div class="cart">
    <a  href="${pageContext.request.contextPath}/cart_show.action">购物车</a>
</div>
<div class="phone">
    客服热线:
    <strong>(929)453-0625</strong>
</div>
</div>

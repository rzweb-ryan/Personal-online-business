...
<script type="application/javascript">
    function checkUsername() {
        ...
        $("#usernameSpan").load("${pageContext.request.contextPath}/user_checkUsername.action?" + new Date().getTime(), {'username': username});
    }
    ...
    <div class="span24">
        <div class="wrap">
            <div class="main clearfix">
                ...
                <form id="registerForm" action="${pageContext.request.contextPath}/user_reg.action" method="post"
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="username" name="username" class="text" maxlength="20"
                                       onblur="checkUsername()"><span id="usernameSpan"></span>
                        ...
                        <tr>
                            <th>
                                <span class="requiredField">*</span>phone:
                            </th>
                            <td>
